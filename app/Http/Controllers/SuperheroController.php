...
class SuperheroController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      if ($request->filled('searchGender')) {
        ...
        return view('superhero.index',compact('superheroes','filters'));
    ...
    public function edit_superpower($id,$id_power,Request $level)
    {
       ...
       // poders($id);
        ...
        $superpowers = Superpower::all();
        return view('superhero.poders',compact('superpowers','superhero'));
    }
    ...
    public function add_superpower($id,Request $id_power)
    {
        ...
        try {
            ...
            $superhero->load("superpowers");
            $superpowers = Superpower::all();
            return redirect()->route('superhero.poders',compact('superpowers','superhero','id'))->with('error','Error al afegir poder.');
        }   
       ...
       // poders($id);
        $superhero->load("superpowers");
        $superpowers = Superpower::all();
        return redirect()->route('superhero.poders',compact('superpowers','superhero','id'))->with('success','Poder afegit correctament.');
    }
    ...
    {
        $planets = Planet::all();
        return view('superhero.create',compact('planets'));
    ...
    public function edit($id)
    {
        $superhero = Superhero::findOrFail($id);
        $planets = Planet::all();
        return view('superhero.edit',compact('superhero','planets'));
    }
